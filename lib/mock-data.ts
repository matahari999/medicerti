...
// ⬇️ youtubeId: 만든 동영상을 YouTube에 '미등록(Unlisted)'으로 올린 뒤,
...
export const mockEducationCourses: EducationCourse[] = [
  ...
  { id: '6', title: '낙상 고위험군 환자를 위한 4가지 특별 관리 수칙', category: 'patient_safety', hospitalType: 'nursing', duration: 20, description: '낙상 고위험군 환자 대상 4가지 특별 관리 수칙', mandatory: true, youtubeId: 'bNLb487z29Y' },
  ...
  { id: '3', title: '화재 대피 훈련', category: 'fire_safety', hospitalType: 'nursing', duration: 90, description: '화재 발생 시 대피 절차', mandatory: true, youtubeId: 'XMm4l7-x1xI' },
  { id: '4', title: '환자 권리 교육', category: 'human_rights', hospitalType: 'nursing', duration: 45, description: '환자 권리와 의무', mandatory: true, youtubeId: 'k0i09bXy3xg' },
  { id: '5', title: '의료기관 인증 이해', category: 'quality', hospitalType: 'nursing', duration: 60, description: '4주기 인증기준 개요', mandatory: false, youtubeId: 'G_5xOgtXI_U' },
];
