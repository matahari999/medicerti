...
export const UPDATE_ENTRIES: UpdateEntry[] = [
  ...
  },
  {
    ...
    summary:
      '4주기 한방병원 인증기준은 3주기와 동일하게 적용 결정(개정사항 없음). 11장·60기준 체계 유지. 표준지침서 변경도 법령 인용 갱신·용어 정비 수준이나, 1.3 화재안전 하위 항목(예방점검·소방교육·금연)이 필수로 지정됨(3·4주기 비교표 확인). 인증기간 중 "최우선관리 기준" 별도 선정, 중간조사·수시조사 등 사후관리 절차 포함.',
